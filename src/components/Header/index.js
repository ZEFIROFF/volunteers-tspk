    ...
    return (
        <header>
            <div className="container-xxl p-0">
                <nav className="row mx-md-auto justify-content-between align-items-center">
                    <div className="col col-md-4"><img className="d-block mx-auto mx-md-0" src={logo} alt={logo}/></div>
                    <ul className={s.navbar + " col col-xl-7 row "}>
                ...
                <div className={s.title + " container-md row mx-auto justify-content-between p-0"}>
                    ...
                    <img className="img-fluid" src={emoji} alt="emoji"/>
                    </div>
                </div>
            </div>
        </header>
